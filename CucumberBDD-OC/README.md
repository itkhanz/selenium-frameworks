  ...
  * [Framework](#framework)
    ...
    + [Framework - Cucumber cross-platform parallel browser execution using Selenium Grid](#framework---cucumber-cross-platform-parallel-browser-execution-using-selenium-grid)
      ...
      - [Hub and Node](#hub-and-node)
        * [[Events](https://www.selenium.dev/documentation/grid/configuration/cli_options/#events)](#-events)
        * [[Node](https://www.selenium.dev/documentation/grid/configuration/cli_options/#node)](#-node)
        * [[Server](https://www.selenium.dev/documentation/grid/configuration/cli_options/#server)](#-server)
