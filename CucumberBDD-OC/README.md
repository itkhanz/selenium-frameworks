  ...
  * [Framework](#framework)
    ...
    + [Framework - Cucumber cross-platform parallel browser execution using Selenium Grid](#framework---cucumber-cross-platform-parallel-browser-execution-using-selenium-grid)
      ...
      - [Hub and Node](#hub-and-node)
        * [[Events](https://www.selenium.dev/documentation/grid/configuration/cli_options/#events)](#-events--https---wwwseleniumdev-documentation-grid-configuration-cli-options--events-)
        * [[Node](https://www.selenium.dev/documentation/grid/configuration/cli_options/#node)](#-node--https---wwwseleniumdev-documentation-grid-configuration-cli-options--node-)
        * [[Server](https://www.selenium.dev/documentation/grid/configuration/cli_options/#server)](#-server--https---wwwseleniumdev-documentation-grid-configuration-cli-options--server-)
      ...
      - [Start Selenium Grid Hub and Node](#start-selenium-grid-hub-and-node)
        * [[Querying Selenium Grid](https://www.selenium.dev/documentation/grid/getting_started/#querying-selenium-grid)](#-querying-selenium-grid--https---wwwseleniumdev-documentation-grid-getting-started--querying-selenium-grid-)
